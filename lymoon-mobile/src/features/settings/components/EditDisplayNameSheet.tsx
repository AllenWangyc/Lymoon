...
export function EditDisplayNameSheet({ visible, onClose, onConfirm, currentName }: Props) {
    ...
    <BottomSheet visible={visible} onClose={onClose} height={280} keyboardAware>
      <View className="px-6 pt-2 pb-8 gap-5">
        ...
        <View className="gap-2">
          ...
          <Text className="text-right" style={{ fontSize: 12, color: '#94a3b8' }}>
        ...
        >
          <Text style={{ fontSize: 15, fontWeight: '600', color: '#0f172a' }}>Save</Text>
        </TouchableOpacity>
      </View>
    </BottomSheet>
  );
